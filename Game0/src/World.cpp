...
void World::Init()
{
	...
	breezeAPI.AddTranform(entity, Vector2f(300, 500), Vector2f(0, 0), 90, Vector2f(1.5, 0.5f));
	...
	breezeAPI.AddTranform(entity2, Vector2f(0, 100), Vector2f(.1f, -.1f), 90, Vector2f(.5f, .3f));
	breezeAPI.AddCollision(entity2);
}
